...
public class BroadcastEmailCommandHandler : IRequestHandler<BroadcastEmailCommand>
{
    ...
    public BroadcastEmailCommandHandler(
        IEmailTemplatesService emailTemplatesService, 
        IEmailsService emailsService, 
        IEmailFactory emailFactory, 
        ILogger<BroadcastEmailCommandHandler> logger)
    {
    ...
    public async Task<Unit> Handle(BroadcastEmailCommand command, CancellationToken cancellationToken)
    {
        ...
        await _emailsService.BroadcastAsync(
            to: command.To,
